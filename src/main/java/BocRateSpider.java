...
public class BocRateSpider {
     ...
     * @return
     */
    public static List<BocRate> getBankExchangeRate(String currency, LocalDate start,LocalDate end,int index){
        ...
        LocalDate d1 = start==null?LocalDate.now():start;
        LocalDate d2 = end==null?LocalDate.now():end;
...
            int totalPageNum = (totalRecord + pageSize - 1) / pageSize; 
    ...
    private static String sendHttp(String currency, LocalDate start,LocalDate end,int page){
